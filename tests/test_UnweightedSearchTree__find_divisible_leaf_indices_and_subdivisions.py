...
def test_UnweightedSearchTree__find_divisible_leaf_indices_and_subdivisions_01():
    ...
    a = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent(0, ["A"]), 0, 1
    )
    b = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((1, 5), ["B"]), 0, 1
    )
    c = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((1, 4), ["C"]), 0, 1
    )
    d = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((1, 3), ["D"]), 0, 1
    )
    e = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((2, 5), ["E"]), 0, 1
    )
    f = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((1, 2), ["F"]), 0, 1
    )
    g = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((3, 5), ["G"]), 0, 1
    )
    h = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((2, 3), ["H"]), 0, 1
    )
    i = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((3, 4), ["I"]), 0, 1
    )
    j = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent((4, 5), ["J"]), 0, 1
    )
    k = abjadext.nauert.QEventProxy(
        abjadext.nauert.SilentQEvent(1, ["K"]), 0, 1
    )
