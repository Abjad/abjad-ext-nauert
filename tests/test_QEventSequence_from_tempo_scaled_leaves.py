...
def test_QEventSequence_from_tempo_scaled_leaves_01():
    ...
    assert q_events == abjadext.nauert.QEventSequence(
        (
            ...
            abjadext.nauert.PitchedQEvent(
                abjad.Offset(30000, 11), pitches=(abjad.NamedPitch("cs'"),)
            ),
            abjadext.nauert.PitchedQEvent(
                abjad.Offset(42000, 11), pitches=(abjad.NamedPitch("d'"),)
            ),
            abjadext.nauert.PitchedQEvent(
                abjad.Offset(54000, 11), pitches=(abjad.NamedPitch("ef'"),)
            ),
            abjadext.nauert.SilentQEvent(abjad.Offset(60000, 11)),
            abjadext.nauert.PitchedQEvent(
                abjad.Offset(84000, 11), pitches=(abjad.NamedPitch("ef'"),)
            ),
            abjadext.nauert.PitchedQEvent(
...
def test_QEventSequence_from_tempo_scaled_leaves_02():
    ...
    assert q_events == abjadext.nauert.QEventSequence(
        (
            ...
            abjadext.nauert.PitchedQEvent(
                abjad.Offset(75000, 29), pitches=(abjad.NamedPitch("cs'"),)
            ),
            abjadext.nauert.PitchedQEvent(
                abjad.Offset(105000, 29), pitches=(abjad.NamedPitch("d'"),)
            ),
            abjadext.nauert.PitchedQEvent(
                abjad.Offset(135000, 29), pitches=(abjad.NamedPitch("ef'"),)
            ),
            abjadext.nauert.SilentQEvent(abjad.Offset(150000, 29)),
            abjadext.nauert.PitchedQEvent(
                abjad.Offset(15600000, 2233), pitches=(abjad.NamedPitch("ef'"),)
            ),
            abjadext.nauert.PitchedQEvent(
